...
define('G5_MYSQL_USER', 'fmddb');
define('G5_MYSQL_PASSWORD', 'fmddbpw');
define('G5_MYSQL_DB', 'fmd');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'fmd_');

define('G5_TOKEN_ENCRYPTION_KEY', '608154da63c816011da87c76176b2ac4'); // 토큰 암호화에 사용할 키
